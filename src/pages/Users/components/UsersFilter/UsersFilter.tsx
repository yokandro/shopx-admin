...
import { AccountStatuses, Roles } from "src/gql/generated.graphql";

import type { UsersFilterType } from "./types";

const UsersFilter: FC<UsersFilterType> = ({ className }) => {
  ...
  const statusesOptions = Object.values(AccountStatuses).map((status) => ({
    value: status,
          ...
          <div style={contentStyle} className="p-4">
            ...
            <div className="flex flex-col w-[200px]">
              ...
              <Select
                ...
                onChange={handleFiltersChange("roles")}
              />
            </div>
          </div>
        )}
